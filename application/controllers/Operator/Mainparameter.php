...
class Mainparameter extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->userdata('role_id') == 3) {
            ...
            $this->load->view('operator/mainparameter', $data);
    ...
    public function addSpecies()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect('Operator/Mainparameter');
        }
    }
    ...
    public function addMainAbiotic()
    {
        ...
        $this->db->insert('main_abiotic_station', $data);
        $this->session->set_flashdata('success', 'Values has been added');
        redirect('Operator/Addparameter');
    }
}
