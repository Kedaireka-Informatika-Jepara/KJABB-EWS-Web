                                ...
                                <?php foreach ($station as $row) : ?>
                                    <tr>
                                        ...
                                        <td><button class="btn btn-danger" href="#" data-toggle="modal" data-target="#hasilModal<?= $row->id; ?>"><i class="fas fa-chart-bar"></i> Result</button>
                                            <a class="btn btn-secondary" href="<?= base_url('Admin/Data/update/' . $row->station_id); ?>"><i class="fas fa-edit"></i> Edit</a>
                                            <a class="btn btn-success" href="<?= base_url('Admin/Data/cetak/' . $row->station_id); ?>"><i class="fas fa-print"></i> Print</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
