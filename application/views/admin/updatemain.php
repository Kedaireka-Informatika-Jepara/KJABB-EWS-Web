                ...
                <div class="bs-stepper-content">
                    <div class="row mb-3">
                        <div class="col-sm">
                            ...
                            <div class="row ml-2">
                                <form class="makrobenthic" method="post" action="<?= base_url('Admin/Updatemain/addSpecies'); ?>">
                        ...
                        <div class="col-sm">
                            ...
                            <div class="row ml-2">
                                <form class="mainparameter" method="post" action="<?= base_url('Admin/Updatemain/updatemainabiotic') ?>">
                                    ...
                                    <?php endforeach; ?>
                                    <a class="btn btn-secondary mt-4" style="float: left;" href="<?= base_url('Admin/Updatestation'); ?>">Back</a>
...
<?php foreach ($species as $row) : ?>
    <!-- Modal Delete User-->
    <form class="user" method="post" action="<?= base_url('Admin/Updatemain/deleteSpecies'); ?>">
