                ...
                <div class="bs-stepper-content">
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            ...
                            <form class="result" method="post" action="<?= base_url('Admin/Updateresult/updateResult'); ?>">
                                ...
                                <a class="btn btn-secondary mt-4" style="float: left;" href="<?= base_url('Admin/Updateadd'); ?>"> Back</a>
                        </div>
                        <div class="col-sm-6">
                            <div class="table-responsive">
