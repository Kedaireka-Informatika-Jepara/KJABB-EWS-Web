    ...
    <div class="main-menu">
        <div class="scroll">
            <ul class="list-unstyled">
                ...
                <li>
                    <a href="#layouts">
                        <i class="iconsminds-digital-drawing"></i> Operator
                    </a>
                </li>
                <li>
                    <a href="#applications">
                        <i class="iconsminds-air-balloon-1"></i> Member
                    </a>
                </li>
                <!-- <li>
                    <a href="#ui">
            ...
            <ul class="list-unstyled" data-link="applications">
                <li>
                    <a href="Apps.MediaLibrary.html">
                        <i class="simple-icon-picture"></i> <span class="d-inline-block">Input Data</span>
                    </a>
                </li>
                <li>
                    <a href="Apps.Todo.List.html">
                        <i class="simple-icon-check"></i> <span class="d-inline-block">Histori Pengisian</span>
                    </a>
                </li>
                <!-- <li>
