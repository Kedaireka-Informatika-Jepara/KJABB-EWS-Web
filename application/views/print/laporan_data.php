...
<body>
    ...
    <div id="main">
        <div class="row" id="station">
            ...
            <p>Station <?php echo $row->station_id ?> (<?php echo $row->zone ?> Zone - <?php echo $row->water ?> Ecosystem)<br>Status: <?php echo $row->status ?> (<?php echo $row->result ?>)<br>Created by: <?php echo $row->name ?></p>
        </div>
