<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Update Main Parameter</h1>
                ...
                <div class="bs-stepper-content">
                    <div class="row mb-3">
                        <div class="col-sm">
                            ...
                            <div class="row ml-2">
                                <form class="makrobenthic" method="post" action="<?= base_url('Operator/Updatemain/addSpecies'); ?>">
                        ...
                        <div class="col-sm">
                            ...
                            <div class="row ml-2">
                                <form class="mainparameter" method="post" action="<?= base_url('Operator/Updatemain/updatemainabiotic') ?>">
                                    <?php foreach ($value_input as $row) : ?>
                                        <div class="form-group">
                                            <label class="col-form-label" for="temperature">Temperature(&#8451;):</label>
                                            <input type="number" class="form-control" id="temperature" name="temperature" min="0" max="100" step="0.01" value="<?= $row->temperature ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="col-form-label" for="salinity">Salinity:</label>
                                            <input type="number" class="form-control" id="salinity" name="salinity" min="0" step="0.01" value="<?= $row->salinity ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="col-form-label" for="do">DO(mg/L):</label>
                                            <input type="number" class="form-control" id="do" name="do" min="0" max="13" step="0.01" value="<?= $row->do ?>">
                                        </div>
                                        <div class="form-group">
                                            <label class="col-form-label" for="ph">pH:</label>
                                            <input type="number" class="form-control" id="ph" name="ph" min="0" max="14" step="0.01" value="<?= $row->ph ?>">
                                        </div>
                                    <?php endforeach; ?>
                                    <a class="btn btn-secondary mt-4" style="float: left;" href="<?= base_url('Operator/Updatestation'); ?>">Back</a>
...
<?php foreach ($species as $row) : ?>
    <!-- Modal Delete User-->
    <form class="user" method="post" action="<?= base_url('Operator/Updatemain/deleteSpecies'); ?>">
