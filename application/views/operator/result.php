                ...
                <div class="bs-stepper-content">
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            ...
                            <form class="result" method="post" action="<?= base_url('Operator/Result/addResult'); ?>">
                                ...
                                <a class="btn btn-secondary mt-4" style="float: left;" href="<?= base_url('Operator/Addparameter'); ?>"> Back</a>
                        </div>
                        <div class="col-sm-6">
                            <div class="table-responsive">
                            ...
                            <a class="btn btn-secondary mt-4" style="float: left;" href="<?= base_url('Cetak/cetak_laporan_result'); ?>"><i class="fas fa-print"></i> Print</a>
                            <button class="btn btn-secondary mt-4 ml-5" type="submit" value="save"><i class="far fa-save"></i> Save</button>
                        </div>
                    </div>
                    </form>
                </div>
