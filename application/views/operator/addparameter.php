<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Input Additional Parameter</h1>
                ...
                <div class="bs-stepper-content">
                    <div class="row mb-3">
                        <div class="col-sm-3">
                            ...
                            <form class="additionalparameter" method="post" id="formAdd" action="<?= base_url('Operator/Addparameter/addIndexAdditional'); ?>">
                                <div class="form-group">
                                    <label class="col-form-label" for="similarity">Similarity(J):</label>
                                    <input type="number" class="form-control" id="similarity" name="similarity" min="0" max="1" step="0.01">
                                    <label class="col-form-label" for="dominance">Dominance(C):</label>
                                    <input type="number" class="form-control" id="dominance" name="dominance" min="0" max="1" step="0.01">
                                    <label class="col-form-label" for="diversity">Diversity(H'):</label>
                                    <input type="number" class="form-control" id="diversity" name="diversity" min="0" max="4" step="0.01">
                        ...
                        <div class="col-sm-3 ml-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="conductivity" name="conductivity" min="0" step="0.01">
                                <label class="col-form-label" for="ratio">Ration C/N:</label>
                                <input type="number" class="form-control" id="ratiocn" name="ratiocn" min="0" step="0.01">
                                <label class="col-form-label" for="turbidty">Turbidity(ntu):</label>
                                <input type="number" class="form-control" id="turbidity" name="turbidity" min="0" step="0.01">
                            </div>
                            <br>
                            <p>Substrate/Sediment Composition</p>
                            <div class="form-group">
                                <label class="col-form-label" for="sand">Sand(%):</label>
                                <input type="number" class="form-control" id="sand" name="sand" min="0" max="100" step="0.01">
                                <label class="col-form-label" for="clay">Clay(%):</label>
                                <input type="number" class="form-control" id="clay" name="clay" min="0" max="20" step="0.01">
                                <label class="col-form-label" for="silt">Silt(%):</label>
                                <input type="number" class="form-control" id="silt" name="silt" min="0" max="100" step="0.01" ]>
                            </div>
                            <a class="btn btn-secondary" style="float: left;" href="<?= base_url('Operator/Mainparameter'); ?>">Back</a>
