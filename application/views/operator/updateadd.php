                ...
                <div class="bs-stepper-content">
                    <div class="row mb-3">
                        <div class="col-sm-3">
                            ...
                            <form class="additionalparameter" method="post" id="formAdd" action="<?= base_url('Operator/Updateadd/updateIndexAdditional'); ?>">
                        ...
                        <?php endforeach; ?>
                        <a class="btn btn-secondary" style="float: left;" href="<?= base_url('Operator/Updatemain'); ?>">Back</a>
