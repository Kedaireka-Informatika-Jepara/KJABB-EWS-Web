                            ...
                            <?php foreach ($station as $row) : ?>
                                <tr>
                                    ...
                                    <td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalHasil<?= $row->id; ?>"><i class="fas fa-chart-bar"></i> Result</button>
                                        <a class="btn btn-warning" href="<?= base_url('Operator/Datastation/parameter/' . $row->station_id . '/' . $row->user_id); ?>"><i class="far fa-eye"></i> Detail</a>
...
<?php foreach ($station as $row) : ?>
    <form class="user" method="post" action="<?= base_url('Operator/Datastation/delete'); ?>">
